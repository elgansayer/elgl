...
## 9. Skills System
Domain-specific, on-demand workflows for recurring engineering tasks on this codebase are documented as Agent Skills under `.github/skills/<name>/SKILL.md`. Consult (or extend) these before starting related work instead of re-deriving conventions from scratch:
