...
**Action:** Replace sequential async loops with small bounded `Promise.allSettled` batches so independent work overlaps without creating an unbounded provider burst, and isolate per-item failures.
