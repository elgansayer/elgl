...
import { Room, RoomEvent, Track, RemoteTrack, RemoteTrackPublication, RemoteParticipant, VideoPresets } from 'livekit-client';
...
private durationSubscription: Subscription | null = null;
  ...
  private onTrackUnsubscribedBound: ((track: RemoteTrack, publication: RemoteTrackPublication, participant: RemoteParticipant) => void) | null = null;
