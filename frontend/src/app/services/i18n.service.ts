...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    // Private Parties (VIP invite-only audio rooms)
    'privateParty.createTitle': 'Create Private Party',
    'privateParty.createSubtitle': 'Start an invite-only audio room for your friends or study partners.',
    'privateParty.titleLabel': 'Party Title',
    'privateParty.titlePlaceholder': 'Enter a name for your private party...',
    'privateParty.languagePairLabel': 'Language Pair',
    'privateParty.topicLabel': 'Topic',
    'privateParty.inviteFriendsLabel': 'Invite Friends',
    'privateParty.searchPlaceholder': 'Search for friends or language partners...',
    'privateParty.maxInviteesReached': 'You can invite up to {{max}} people.',
    'privateParty.invitedLabel': 'Invited',
    'privateParty.noInviteesHint': 'Search above to add friends to your party.',
    'privateParty.removeInviteeAria': 'Remove {{name}} from invite list',
    'privateParty.createBtn': 'Create Private Party',
    'privateParty.creatingBtn': 'Creating...',
    'privateParty.errorCreate': 'Failed to create private party. Please try again.',
    'privateParty.vipRequired': 'VIP membership required to create private parties.',
    'privateParty.sectionTitle': 'Private Parties',
    'privateParty.sectionSubtitle': 'Your invite-only rooms',
    'privateParty.emptyHint': 'No private party invitations yet.',
    'privateParty.joinBtn': 'Join Party',
    'privateParty.partyTypeLabel': 'Private',
