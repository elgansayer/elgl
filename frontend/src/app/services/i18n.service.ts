...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    'privacy.section.profileVisibility': 'Profile Visibility',
    'privacy.section.profileInfo': 'Profile Information',
    'privacy.section.incognito': 'Incognito Mode',
    'privacy.section.directMessages': 'Direct Messages',
    'privacy.section.friendRequests': 'Friend Requests',
    'privacy.visibility.Everyone': 'Everyone',
    'privacy.visibility.Friends': 'Friends',
    'privacy.visibility.ServerMembers': 'Server Members',
    'privacy.visibility.Nobody': 'Nobody',
    'privacy.dm.allowFromServerMembers': 'Allow direct messages from server members',
    'privacy.dm.imageFilterLevel': 'Explicit Image Filter',
    'privacy.dm.readReceipts': 'Read receipts',
    'privacy.imageFilter.all': 'Scan and delete',
    'privacy.imageFilter.blurred': 'Blur explicit images',
    'privacy.imageFilter.none': 'Do not filter',
    'privacy.friendRequests.allowFromEveryone': 'Allow friend requests from everyone',
    'privacy.friendRequests.allowFromFriendsOfFriends': 'Allow friend requests from friends of friends',
    'privacy.friendRequests.allowFromServerMembers': 'Allow friend requests from server members',
