...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    'readingEngine.discuss': 'Discuss with AI',
    'readingEngine.discussTutor': 'Discuss with Tutor',
    'readingEngine.discussPartner': 'Discuss with Partner',
    'readingEngine.discussRoom': 'Discuss in Room',
    'readingEngine.discussionQuestions': 'Discussion Questions',
    'readingEngine.vocabularyChallengesTitle': 'Vocabulary Challenges',
    'readingEngine.closeDiscussion': 'Close discussion',
    'readingEngine.discussionTitle': 'Discussion ({{type}})',
    'readingEngine.mockDiscussionBody': 'This is a mock discussion interface for communicating with an {{type}}. Actual chat UI would be rendered here.',
    'readingEngine.generateQuestions': 'Generate Questions',
    'readingEngine.conversationStarters': 'Conversation Starters',
    'readingEngine.vocabularyChallenges': 'Vocabulary Challenges',
