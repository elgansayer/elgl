...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    'discovery.filterCity': 'City',
    'discovery.filterPaidPractice': 'Paid Practice',
    'discovery.filterAudioIntros': 'Audio Intros',
    ...
    'discovery.pauseAudioIntro': 'Pause audio introduction',
    'discovery.playAudioIntro': 'Play audio introduction',
    'discovery.partnerCardLabel': '{{ name }} - View profile',
    'discovery.partnerAvatar': '{{ name }} avatar',
    'discovery.partnerListLabel': 'List of language partners',
    'discovery.audioIntroFeed.noAudioIntros': 'No audio introductions yet.',
    'discovery.audioIntroFeed.noAudioIntrosHint': 'When users record spoken introductions they will appear here for you to browse.',
    'discovery.audioIntroFeed.listLabel': 'Browse users with audio introductions',
    'discovery.audioIntroFeed.loading': 'Loading audio introductions...',
    'discovery.audioIntroFeed.matchCount': '{{ count }} users with audio introductions',
    'discovery.audioIntroFeed.loadError': 'Failed to load audio introductions.',
