...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    'events.titleWhat': 'Title (What)',
    'events.titlePlaceholder': 'Enter event title',
    'events.datetime': 'Date & Time',
    'events.dateTimeWhen': 'Date & Time (When)',
    'events.location': 'Platform/Location',
    'events.locationWhere': 'Platform/Location (Where)',
    'events.locationSelect': '-- Select a platform --',
    'events.whereHint': 'e.g., Audio Room, Zoom, In-person',
    'events.wherePlaceholder': 'Enter a platform or location',
    'events.locationAudio': 'Audio Room',
    'events.locationZoom': 'Zoom',
    'events.locationInPerson': 'In Person',
    'events.description': 'Description',
    'events.descriptionPlaceholder': 'Enter a description',
