...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    'audioSync.immersionDescription': 'Tap any word to see its translation and save it to your flashcard deck.',
    'audioSync.immersionLessonTitle': 'Immersive Reading Lesson',
    'audioSync.pauseImmersionAudio': 'Pause immersion audio',
    'audioSync.playAudioLesson': 'Play audio lesson',
    'audioSync.readingContentLabel': 'Immersive reading content. Tap words for definitions.',
    'audioSync.speechSynthesisUnavailable': 'Speech synthesis is not available in your browser.',
    'audioSync.tapWordAriaLabel': 'Tap "{word}" for translation and flashcard options',
    ...
    'wordDef.lingqDialogAriaLabel': 'LingQ word definition for "{word}"',
    'wordDef.closeDialogAriaLabel': 'Close word definition',
    'wordDef.loadingDefinition': 'Loading definition and translation',
    'wordDef.srsGroupLabel': 'Save word to spaced repetition system',
