...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    'events.title': 'Events',
    'events.titlePlaceholder': 'Event name...',
    'events.datetime': 'Date & Time',
    'events.dateTime': 'Date & Time',
    'events.where': 'Where',
    'events.whereHint': 'Platform or physical location',
    'events.wherePlaceholder': 'e.g. Zoom, In-person',
    ...
    'events.descriptionPlaceholder': 'What is this event about?',
    'events.filter_upcoming': 'Upcoming',
    'events.filter_past': 'Past',
    'events.all_categories': 'All',
    'events.all_languages': 'All Languages',
    'events.load_more': 'Load More',
    'events.empty_title': 'No events found',
    'events.empty_subtitle': 'Be the first to create an event for language learners!',
    'events.create_first': 'Create an Event',
    'events.hosted_by': 'Hosted by {{name}}',
    'events.attending': 'attending',
    'events.interested': 'interested',
    'events.interested_btn': 'Interested',
    'events.rsvp_attending': 'Attend',
    'events.cat_general': 'General',
    'events.cat_audio_room': 'Audio Room',
    'events.cat_learning_seminar': 'Learning Seminar',
    'events.cat_in_person_meetup': 'In-Person Meetup',
    'events.cat_cultural_exchange': 'Cultural Exchange',
