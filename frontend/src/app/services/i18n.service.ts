...
'doodle.brushSizeAria': 'Brush size {{size}}px',
    ...
    'admin.emptyDesc': 'No users match your current search. Try adjusting your search or clear the filters.',
    'admin.userManagement.emptyTitle': 'No users',
    'admin.userManagement.emptyDesc': 'No users registered yet. New users will appear here.',
    'admin.users.emptyTitle': 'No users',
    'admin.users.emptyDesc': 'No users registered yet. New users will appear here.',
    'admin.skeleton.loading': 'Loading content...',
