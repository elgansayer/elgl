...
<<<<<<< HEAD
    'videoClassroomTour.marketplaceTitle': 'Video Classrooms',
    'videoClassroomTour.marketplaceDesc': 'Browse live video classrooms hosted by language partners. Join a room to practise speaking in real time with native speakers.',
    'videoClassroomTour.roomHeaderTitle': 'Room Controls',
    'videoClassroomTour.roomHeaderDesc': 'Manage your video classroom from here. Raise your hand, send gifts, tip the host, or leave the room.',
    'videoClassroomTour.hostVideoTitle': 'Host Video',
    'videoClassroomTour.hostVideoDesc': 'Watch the host\'s live video stream here. For hosts: your own camera feed is shown in this tile.',
    'videoClassroomTour.coHostInviteTitle': 'Invite Co-Host',
    'videoClassroomTour.coHostInviteDesc': 'Invite an eligible speaker to be your co-host. They will appear in a split-screen layout alongside you.',
    'videoClassroomTour.liveChatTitle': 'Live Chat',
    'videoClassroomTour.liveChatDesc': 'Chat in real time with other participants while watching the video stream. Corrections and translations appear here.',
    'tour.prev': 'Previous',
    'tour.next': 'Next',
    'tour.done': 'Done',
    'tour.close': 'Skip',
