...
'doodle.brushSizeAria': 'Brush size {{size}}px',
    ...
    'moderation.offlineMode': 'Offline',
    'moderation.pendingActions': '{{count}} pending offline',
    'moderation.syncFailed': 'Some offline actions failed to sync.',
    'moderation.retrySync': 'Retry',
    'moderation.actionQueuedOffline': 'Action queued for sync when online.',
