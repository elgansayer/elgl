...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    'discovery.noResultsDescription': 'Try adjusting your filters or widening your search area to discover more language partners.',
    'discovery.noResultsAction': 'Reset Filters',
    'discovery.searchErrorTitle': 'Something went wrong',
    'discovery.searchErrorDescription': 'We couldn\'t load partner results. Please check your connection and try again.',
    'discovery.searchErrorAction': 'Try Again',
    'discovery.searchError': 'Failed to load partners',
    'discovery.searchErrorHint': 'There was a problem connecting to the server. Check your connection and try again.',
...
'doodle.brushSizeAria': 'Brush size {{size}}px',
    ...
    'coinEconomy.emptyTransactionsDesc': 'Your recent coin activity will appear here. Start by claiming your daily reward!',
    'coinEconomy.emptyActivityTitle': 'No Recent Activity',
    'coinEconomy.emptyActivityDesc': 'Your coin economy activity will appear here. Start by exploring gifts and sticker packs.',
    ...
    'coinEconomy.transaction.premium_service': 'Premium AI Service',
    'coinEconomy.premiumServices': 'Premium AI Services',
    'coinEconomy.premiumServicesDesc': 'Unlock one-off AI-powered analysis reports using your coins.',
    'coinEconomy.unlockReport': 'Unlock Report',
    'coinEconomy.unlockReportCost': 'Cost: {{coins}} coins',
    'coinEconomy.premiumServiceUnlocked': '{{name}} unlocked successfully!',
    'coinEconomy.premiumServiceInsufficientCoins': 'Insufficient coins for this service.',
    'coinEconomy.conversationAnalysisReport.title': 'Conversation Analysis Report',
    'coinEconomy.conversationAnalysisReport.desc': 'Get a deep AI-powered analysis of your chat patterns, language mix, correction ratios, and personalised improvement suggestions.',
    'coinEconomy.conversationAnalysisReport.reportTitle': 'Analysis Report for {{name}}',
    'coinEconomy.report.totalMessages': 'Total messages',
    'coinEconomy.report.messagesByUser': 'Messages by you',
    'coinEconomy.report.messagesByPartner': 'Messages by partner',
    'coinEconomy.report.firstMessageDate': 'First message',
    'coinEconomy.report.lastMessageDate': 'Last message',
    'coinEconomy.report.daysSinceFirst': 'Days since first contact',
    'coinEconomy.report.avgPerDay': 'Average messages / day',
    'coinEconomy.report.messageTypes': 'Message types',
    'coinEconomy.report.corrections': 'Corrections exchanged',
    'coinEconomy.report.correctionsGiven': 'Corrections given',
    'coinEconomy.report.correctionsReceived': 'Corrections received',
    'coinEconomy.report.engagementScore': 'Engagement score',
    'coinEconomy.report.engagementRating': 'Rating',
    'coinEconomy.report.keyInsights': 'Key insights',
    'coinEconomy.report.suggestions': 'Suggestions',
