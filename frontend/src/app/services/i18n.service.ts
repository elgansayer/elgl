...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    'audioRoom.sessionSummaryTitle': '🤖 AI Session Summary',
    'audioRoom.sessionSummaryEmpty': 'No session summary available for this recording.',
    'audioRoom.sessionSummaryLoading': 'Loading session summary...',
    'audioRoom.keyTopicsLabel': '📋 Key Topics',
    'audioRoom.keyVocabularyLabel': '📚 Key Vocabulary',
    'audioRoom.noVocabulary': 'No key vocabulary identified for this session.',
    'audioRoom.viewArchivedSummary': '📊 View Session Summary',
    'audioRoom.vocabularySavedToast': 'Word saved to your vocabulary!',
    'audioRoom.closeSummary': 'Close session summary',
