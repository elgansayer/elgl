...
export class I18nService {
  ...
  private readonly baseDictionary: Record<string, string> = {
    ...
    'escrow.loadError': 'Failed to load escrow transactions. Please try again.',
    ...
    'escrow.releaseSuccess': 'Escrow payment released successfully.',
    'escrow.releaseError': 'Failed to release escrow payment.',
    'escrow.refundSuccess': 'Escrow payment refunded successfully.',
    'escrow.refundError': 'Failed to refund escrow payment.',
    'escrow.disputeSuccess': 'Escrow payment disputed successfully.',
