    ...
    <div class="flex h-full">
      ...
      <aside class="w-80 border-e border-surface-100  overflow-y-auto">
        <div class="p-4">
          ...
          <!-- ⚡ Bolt: Using room.id for track to prevent unnecessary DOM recreations during state updates -->
          ...
          @if (selectedRoom(); as room) {
            <div class="flex-1 flex flex-col">
              ...
              <div class="flex-1 overflow-y-auto p-4 space-y-4" #messagesContainer>
                <!-- ⚡ Bolt: Using msg.id for track to prevent unnecessary DOM recreations during state updates -->
