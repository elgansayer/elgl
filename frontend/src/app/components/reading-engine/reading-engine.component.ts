  ...
  >
    ...
    <header class="app-card app-padded space-y-3 sm:space-y-4">
      <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <span
          class="app-chip bg-primary/20 text-primary font-bold text-[10px] sm:text-xs px-2 sm:px-3 py-1"
        >
      ...
      >
        @for (tabId of tabIds; track tabId) {
          <button
            ...
            [class.text-white]="activeTab() === tabId"
        ...
        @if (selectedArticle(); as article) {
          <div class="space-y-4">
            ...
            <div class="flex flex-wrap gap-2">
              <button
                type="button"
                class="app-button-secondary text-[11px] sm:text-xs font-bold py-2.5 sm:py-2 px-3 sm:px-4 min-h-[44px] sm:min-h-0"
              ...
              <div class="flex items-center gap-1 sm:gap-1.5 overflow-x-auto pb-1 sm:pb-0">
                ...
                @for (diff of ['beginner', 'intermediate', 'advanced']; track diff) {
                  <button
                    ...
                    [class.text-white]="filterDifficulty() === diff"
              ...
              <div class="flex items-center gap-1 sm:gap-1.5 overflow-x-auto pb-1 sm:pb-0">
                ...
                @for (topic of distinctTopics(); track topic) {
                  <button
                    ...
                    [class.text-white]="filterTopic() === topic"
