    ...
    >
      <div class="absolute" [style.top.px]="y()" [style.left.px]="x()">
        ...
        >
          <button
            (click)="onCopy()"
            class="w-full text-start px-4 py-2 text-sm text-gray-200 hover:bg-surface-100 flex items-center gap-2"
          >
            ...
            {{ 'components.message-context-menu.copy' | t }}
          </button>
          <button
            (click)="onFavourite()"
            class="w-full text-start px-4 py-2 text-sm text-gray-200 hover:bg-surface-100 flex items-center gap-2"
          >
            ...
            {{ 'components.message-context-menu.favourite' | t }}
          </button>
          <button
            (click)="onReport()"
            class="w-full text-start px-4 py-2 text-sm text-red-400 hover:bg-surface-100 flex items-center gap-2"
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                stroke-linecap="round"
            ...
            {{ 'components.message-context-menu.report' | t }}
          </button>
        </div>
      </div>
    </div>
