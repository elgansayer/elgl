      ...
      >
        <div class="flex items-center justify-between border-b border-surface-100 pb-3">
          <div>
            ...
            <p class="text-xs text-text-secondary ps-1">
        ...
        @if (mode === 'block') {
          <div
            ...
            role="alert"
          >
            <span class="font-bold text-red-900 block ps-1"
              >{{ 'safety.blockWarning' | t: { name: targetName() } }}</span
            >
            <ul class="list-disc list-inside space-y-1 text-text-primary ps-4">
