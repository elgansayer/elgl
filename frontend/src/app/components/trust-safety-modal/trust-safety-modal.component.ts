...
@Component({
  ...
  template: `
    <div class="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
      <div
        class="bg-white dark:bg-slate-800 rounded-3xl p-6 max-w-md w-full shadow-2xl border border-slate-200 dark:border-slate-700 space-y-5 animate-fadeIn"
      >
        <!-- Header -->
        <div
          ...
          <div class="space-y-3 text-xs">
            <div>
              ...
              <select
                ...
                class="w-full px-3 py-2 border rounded-xl bg-slate-50 dark:bg-slate-700 font-medium"
              >
        ...
        @if (mode === 'block') {
          <div
            class="bg-red-50 dark:bg-red-950/40 p-4 rounded-2xl border border-red-200 dark:border-red-800 space-y-2 text-xs"
          >
            <span class="font-bold text-red-900 dark:text-red-300 block"
