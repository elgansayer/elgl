...
@Component({
  ...
  template: `<div class="min-h-screen bg-surface-300 text-text-primary">
    ...
    <section
      class="bg-gradient-to-br from-indigo-900/40 via-surface-200 to-surface-300 ps-4 pe-4 pt-8 pb-12 md:ps-8 md:pe-8"
    >
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <app-card variant="elevated" padding="md">
            <div
              joyrideStep="coinEconomyStepBuyCoins"
          ...
          <app-card variant="elevated" padding="md">
            <div
              joyrideStep="coinEconomyStepSendGift"
              class="flex flex-col items-center text-center gap-3"
            >
              <span class="text-4xl" aria-hidden="true">🎁</span>
          ...
          <app-card variant="elevated" padding="md">
            <div
              joyrideStep="coinEconomyStepStickerStore"
              class="flex flex-col items-center text-center gap-3"
            >
          ...
          <app-card variant="elevated" padding="md">
            <div
              joyrideStep="coinEconomyStepShop"
              class="flex flex-col items-center text-center gap-3"
            >
              <span class="text-4xl" aria-hidden="true">🛍️</span>
          ...
          <app-card variant="elevated" padding="md">
            <div
              joyrideStep="coinEconomyStepVIP"
              class="flex flex-col items-center text-center gap-3"
            >
              <span class="text-4xl" aria-hidden="true">👑</span>
