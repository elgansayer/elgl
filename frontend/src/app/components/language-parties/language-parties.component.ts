        ...
        @if (partiesResource.isLoading()) {
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
            @for (party of parties(); track party.id) {
              ...
              >
                ...
                <div class="flex flex-wrap items-center gap-2 mb-3">
                  @if (party.language_pair) {
                    <span
                      class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-purple-500/15 text-purple-300 border border-purple-500/25"
                    >
                  ...
                  @if (party.topic_tag) {
                    <span
                      class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-emerald-500/15 text-emerald-300 border border-emerald-500/25"
                    >
                      #{{ party.topic_tag }}
                    </span>
                  }
                  @if (party.level) {
                    <span
                      class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-amber-500/15 text-amber-300 border border-amber-500/25"
                    >
                ...
                <div class="flex items-center gap-2 mb-4">
                  @if (party.host?.avatar_url) {
                    ...
                    <div
                      class="w-7 h-7 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-xs font-bold"
                    >
              ...
              >
                <div
                  class="w-24 h-24 rounded-full bg-slate-800 flex items-center justify-center mb-6"
                >
