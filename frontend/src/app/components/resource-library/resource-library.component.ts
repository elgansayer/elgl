  ...
  template: `
    <div class="p-2 sm:p-4 md:p-6 max-w-5xl mx-auto">
      ...
      >
        ...
        <button
          type="submit"
          class="bg-blue-600 text-white px-4 py-2 rounded-app text-sm font-semibold min-h-[44px]"
        >
              ...
              >
                <div class="min-w-0 flex-1">
                  <a
                    [href]="resource.url"
                    target="_blank"
                    class="text-blue-400 underline text-sm sm:text-base font-semibold break-all"
                    >{{ resource.title }}</a
                  >
                  ...
                  <div class="flex flex-wrap gap-1 mt-1">
                    ...
                    @if (resource.topic) {
                      <span
                        class="text-2xs sm:text-xs font-semibold bg-blue-500/20 text-blue-400 rounded px-1.5 py-0.5"
                        >{{ resource.topic }}</span
                      >
                    }
                    @if (resource.difficulty) {
                      <span
                        class="text-2xs sm:text-xs font-semibold bg-emerald-500/20 text-emerald-400 rounded px-1.5 py-0.5"
                ...
                <div class="flex gap-2 self-end sm:self-start flex-shrink-0">
                  <button
                    ...
                    class="text-amber-400 text-xs sm:text-sm font-semibold min-h-[36px] sm:min-h-0 px-2 py-0.5 rounded-app hover:bg-surface-200"
                  >
                    {{ 'resource_library.edit' | t }}
                  </button>
                  <button
                    (click)="onDelete(resource.id)"
                    class="text-red-400 text-xs sm:text-sm font-semibold min-h-[36px] sm:min-h-0 px-2 py-0.5 rounded-app hover:bg-surface-200"
                  >
