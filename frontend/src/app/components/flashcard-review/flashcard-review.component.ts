...
@Component({
  ...
  template: `
    ...
    <div class="mx-auto max-w-md space-y-6 pb-20 pt-4">
      ...
      <!-- Skeleton Loader -->
      @if (isLoading()) {
        <section class="space-y-4" role="status" aria-label="{{ 'review.loading' | t }}">
          <div class="rounded-sheet border border-surface-100 bg-surface-200 p-6 space-y-4">
            <div class="flex items-center justify-between">
              <app-skeleton-loader height="22px" width="80px" borderRadius="6px" />
              <app-skeleton-loader height="16px" width="60px" borderRadius="4px" />
            </div>
            <app-skeleton-loader height="36px" width="70%" borderRadius="8px" />
            <app-skeleton-loader height="14px" width="90%" borderRadius="4px" />
            <div class="flex items-center justify-center pt-2">
              <app-skeleton-loader height="12px" width="100px" borderRadius="4px" />
            </div>
          </div>
          <div class="grid grid-cols-4 gap-2">
            <app-skeleton-loader height="72px" width="100%" borderRadius="12px" />
            <app-skeleton-loader height="72px" width="100%" borderRadius="12px" customClass="col-span-2" />
            <app-skeleton-loader height="72px" width="100%" borderRadius="12px" />
          </div>
        </section>
      } @else if (isComplete()) {
