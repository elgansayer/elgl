...
describe('DiscoveryComponent matchmaking filters', () => {
  ...
  it('passes distance, native language, target language and serious-only state to discovery', async () => {
  ...
  it('maps global language-search output into the canonical discovery query', async () => {
  ...
  it('switches the Serious Learner filter without changing unrelated language filters', async () => {
    component.selectedNativeLanguage.set('JA');
    component.selectedTargetLanguage.set('EN');
  ...
  it('keeps existing results when a superseded request is aborted', async () => {
