...
@Component({
  ...
  template: `
    <div class="flex flex-col gap-3 ps-4 pe-4">
      <button
        class="flex items-center justify-center gap-2 w-full rounded-full border-s border-e border-surface bg-surface ps-4 pe-4 py-3 text-sm font-extrabold text-on-surface hover:bg-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
      ...
      >
        <svg class="h-5 w-5 flex-shrink-0" viewBox="0 0 24 24" fill="#1877F2">
