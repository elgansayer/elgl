          ...
          >
            ...
            >
              ...
              @if (pack.owned) {
                ...
                >
                  <span
                    class="rounded-full bg-emerald-500 px-3 py-1 text-xs font-bold text-white shadow-lg"
                  >
            ...
            @if (pack.is_animated) {
              <p class="text-xs text-fuchsia-400 mb-1">
                {{ 'stickerStore.animatedDescription' | t }}
              </p>
            }
