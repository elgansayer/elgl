...
export class StickerStoreComponent {
  ...
  readonly stickers = signal<Sticker[]>([
    { id: 'stk_1', name: 'Happy Corgi', imageUrl: 'https://api.dicebear.com/7.x/bottts/svg?seed=Corgi', coinPrice: 50, isPremium: false },
    { id: 'stk_2', name: 'Golden Dragon', imageUrl: 'https://api.dicebear.com/7.x/bottts/svg?seed=Dragon', coinPrice: 500, isPremium: true },
    { id: 'stk_3', name: 'Study Owl', imageUrl: 'https://api.dicebear.com/7.x/bottts/svg?seed=Owl', coinPrice: 100, isPremium: false },
    { id: 'stk_4', name: 'Party Parrot', imageUrl: 'https://api.dicebear.com/7.x/bottts/svg?seed=Parrot', coinPrice: 150, isPremium: false },
  ]);
