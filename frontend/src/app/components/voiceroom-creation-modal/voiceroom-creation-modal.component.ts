    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div class="bg-white dark:bg-slate-800 rounded-xl shadow-xl w-full max-w-md p-6 m-4">
        <div class="flex justify-between items-center mb-6">
          <h2 class="text-xl font-bold text-slate-900 dark:text-white text-start">Create Voice Room</h2>
        ...
        <form (ngSubmit)="onSubmit()" class="space-y-4">
          ...
          <div>
            <label for="voiceroomLanguagePairInput" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 text-start">Language Pair</label>
            <input
          ...
          <div>
            <label for="voiceroomTopicSelect" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 text-start">Topic</label>
            <select
