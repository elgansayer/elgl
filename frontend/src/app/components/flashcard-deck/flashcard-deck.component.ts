          ...
          <section class="space-y-4">
            ...
            @if (showCreateForm()) {
              <div class="rounded-card border border-surface-100 bg-surface-300 p-4 space-y-3">
                ...
                <div>
                  <label
                    for="deck-create-name"
                    class="mb-1 block text-xs font-bold text-text-primary"
                    >{{ 'deck.nameLabel' | t }}</label
                  >
                  <input
                    id="deck-create-name"
                    [(ngModel)]="newDeckName"
                ...
                <div>
                  <label
                    for="deck-create-description"
                    class="mb-1 block text-xs font-bold text-text-primary"
                    >{{ 'deck.descriptionLabel' | t }}</label
                  >
                  <input
                ...
                <div class="flex flex-wrap gap-3">
                  <div
                    class="min-w-[120px]"
                    role="group"
                    [attr.aria-label]="'deck.colourLabel' | t"
                  >
                  ...
                  <div class="min-w-[120px]" role="group" [attr.aria-label]="'deck.iconLabel' | t">
                    <span class="mb-1 block text-xs font-bold text-text-primary">{{
                      'deck.iconLabel' | t
                    }}</span>
                    <div class="flex flex-wrap gap-1.5">
            ...
            <section class="space-y-4">
              ...
              @if (showEditForm()) {
                <div class="rounded-card border border-surface-100 bg-surface-300 p-4 space-y-3">
                  ...
                  <div>
                    <label
                      for="deck-edit-description"
                      class="mb-1 block text-xs font-bold text-text-primary"
                      >{{ 'deck.descriptionLabel' | t }}</label
                    >
                    <input
                      id="deck-edit-description"
                      [(ngModel)]="editDeckDescription"
                      class="app-input w-full"
                      maxlength="120"
                    />
                  </div>
                  <div class="flex flex-wrap gap-3">
                    ...
                    <div
                      class="min-w-[120px]"
                      role="group"
                      [attr.aria-label]="'deck.iconLabel' | t"
                    >
                      <span class="mb-1 block text-xs font-bold text-text-primary">{{
                        'deck.iconLabel' | t
                      }}</span>
