...
- _(No methods found or interface/type definition)_
...
- Methods: `getAllTags`, `createTag`, `getUserTags`, `addUserTag`, `removeUserTag`, `updateProficiency`
...
- Methods: `onModuleInit`, `getVersion`
...
- Methods: `getCatalog`, `getDefaultGiftCatalog`, `getPackages`, `createCheckoutSession`, `getBalance`, `claimDailyCheckIn`, `verifyPurchaseReceipt`, `purchaseCoins`, `parseAndroidReceiptToken`, `extractStripeSessionId`, `getCoinPackageByProductId`, `sendGift`, `unlockStickerPack`
...
### `backend/src/pronunciation-scoring/pronunciation-scoring.service.ts`
...
- Methods: `onModuleInit`, `generateConnectionToken`, `signJwt`, `publish`, `publishTranslated`
...
- Methods: `generateConnectionToken`, `getRooms`, `sendMessage`, `getMessages`, `addFavourite`, `getFavourites`, `deleteFavourite`, `getSuggestedReplies`, `parseSuggestedReplies`, `createGroup`, `renameGroup`, `addGroupMembers`, `removeGroupMember`, `getGroupMembers`, `lockChat`, `unlockChat`, `getLockedChats`, `shareContact`, `setWallpaper`, `getWallpaper`, `replyToStatusUpdate`, `translateMessage`, `llmProxy`, `correctMessage`, `fixMessage`, `deleteMessage`, `viewMessageMedia`, `exportChatHistory`, `addLabel`, `removeLabel`, `getUserLabels`, `getRoomsByLabel`, `getRoomGreeting`, `generateAiReply`
...
- Methods: `createOrUpdateFlashcard`, `updateSrsLevel`, `getFlashcards`, `getDueReviews`
...
- Methods: `startEgress`, `stopEgress`, `generateTranscriptFromAudioUrl`
...
- Methods: `detectLanguage`, `checkRateLimit`, `translate`, `grammarCheck`, `explainGrammar`, `pronunciationScore`, `simplify`, `translateUi`, `translateBio`, `translateAndCorrect`, `transcribeVoiceOnly`, `transcribeVoice`, `generateSessionSummary`
...
- Methods: `createCheckoutSession`, `handleSubscriptionCreated`, `handleSubscriptionUpdated`, `handleSubscriptionDeleted`, `handleInvoicePaymentSucceeded`, `handleInvoicePaymentFailed`
...
- Methods: `hasTargetLanguages`, `getTargetLanguagesText`, `onUnblock`
...
- Methods: `loadPlans`, `getPriceDisplay`, `getPlanIcon`, `getFeatureCategories`, `getAllFeatures`, `planHasFeature`, `scrollToPlans`, `onSubscribe`
...
- Methods: `ngOnInit`, `loadUsers`, `onSearchInput`, `runSearch`, `goToPage`, `toggleVip`, `onLoginHistoryToggle`, `loginHistoryFor`, `displayNameFor`
...
- Methods: `ngOnInit`, `linkAccount`, `unlinkAccount`, `isLinked`, `providerIcon`, `getLinkedAccount`, `goBack`, `changeUiLanguage`, `goToMySubscription`, `onFontScaleChange`, `setAccentColor`, `toggleInterest`, `removeInterest`, `toggleSoundEffects`, `toggleVibration`, `updateAutoDownloadMode`, `saveSettings`, `clearCache`, `deleteOldMedia`, `downloadData`, `openVersionCheck`
...
- Methods: `ngOnInit`, `addMessage`, `scrollToBottom`, `ngOnDestroy`
...
- Methods: `ngOnInit`, `handleKeyDown`, `next`, `prev`, `goTo`, `onTouchStart`, `onTouchEnd`, `handleSwipe`
...
- Methods: `previousMonth`, `nextMonth`

### `frontend/src/app/components/user-detail/user-detail.component.ts`

- Methods: `goBack`, `loadProfile`, `toggleFollow`, `toggleLike`, `playAudioIntro`
...
- Methods: `isValid`, `closeModal`, `submit`, `resetForm`
...
- Methods: `ngOnInit`, `loadProfile`, `loadVisitors`, `checkMilestone`, `sanitizePrivacyVisibility`, `toggleEdit`, `onVisibilityChange`, `onIncognitoVisitsChange`, `onAvatarFileSelected`, `onCustomAvatarFileSelected`, `onAvatarClick`, `saveProfile`, `playAudioIntro`, `blockProfile`, `unblockProfile`, `reportUser`, `onCoverUploaded`, `getLanguageName`, `getLanguageFlagIcon`, `addNativeLanguage`, `removeNativeLanguage`, `addTargetLanguage`, `removeTargetLanguage`, `addCatalogItem`, `removeCatalogItem`, `updateCatalogItem`

### `frontend/src/app/components/discovery/discovery.component.ts`

- Methods: `setSort`, `onAgeRangeChanged`, `onDistanceChanged`, `onFilterSelect`, `setLanguage`, `setGender`, `ngOnInit`, `searchPartners`, `toggleSeriousLearnerMode`, `formatDistanceHelper`, `toggleAudioIntro`, `stopAudioIntro`, `getActiveStatus`, `ngOnDestroy`, `onGlobalSearch`, `resetFilters`
...
- Methods: `loadFavourites`, `setTab`, `deleteFavourite`, `toggleAudio`, `stopAudio`, `getPayloadMessage`
...
- Methods: `isOwnMessage`, `playVoice`, `simplifyText`, `onCopy`, `onFavourite`, `onReport`
...
- Methods: `onNewPasswordInput`, `onConfirmPasswordInput`, `resetPassword`
...
- Methods: `selectOption`, `next`, `previous`, `finishQuiz`
...
- Methods: `ngOnInit`, `selectExclusiveEmoji`, `createRoom`, `join`, `leave`, `raiseHand`, `approve`, `demote`, `mute`, `kick`, `archive`, `openPollForm`, `closePollForm`, `submitPollForm`, `sendExclusiveReaction`, `viewPollResults`, `voteInPoll`
...
- Methods: `startRecording`, `stopRecording`, `uploadRecording`, `playPreview`, `ngOnDestroy`
...
- Methods: `playRingtone`, `playFallbackBeep`, `stopRingtone`, `onAccept`, `onDecline`, `ngOnDestroy`

### `frontend/src/app/components/image-lightbox/image-lightbox.component.ts`

- Methods: `ngOnInit`, `ngOnDestroy`, `handleKeyDown`, `next`, `prev`, `close`, `onTouchStart`, `onTouchEnd`, `handleSwipe`
...
- Methods: `isRoomEvent`, `findRemoteVideoTrack`, `getHeaders`, `loadActiveRooms`, `loadStage`, `createRoom`, `joinRoom`, `unpublishLocalCamera`, `onTrackSubscribed`, `onTrackUnsubscribed`, `raiseHand`, `approveSpeaker`, `demoteSpeaker`, `muteSpeaker`, `inviteCoHost`, `removeCoHost`, `sendCaption`, `broadcastAICaption`, `sendRoomChatMessage`, `archiveRoom`, `leaveRoom`
...
- Methods: `initDB`, `enqueueMessage`, `getQueuedMessages`, `removeMessage`
...
- Methods: `isVersionLower`, `checkVersion`, `showBlockingModal`
...
- Methods: `createRoom`, `getToken`, `getLiveKitUrl`, `joinRoom`, `publishTracks`, `toggleMute`, `toggleSpeakerphone`, `toggleScreenShare`, `leaveRoom`
...
- Methods: `getBlockedUsers`, `blockUser`, `unblockUser`
...
- Methods: `getHeaders`, `loadInitialData`, `claimDailyCheckIn`, `loadCoinPackages`, `buyCoins`, `confirmCoinPurchase`, `sendGift`, `upgradeVip`, `loadDeveloperAnalytics`, `loadDiagnosticLogs`, `createDiagnosticLog`, `generateApiKey`, `reportUser`, `blockUser`, `triggerGiftAnimation`, `mapDiagnosticLog`
