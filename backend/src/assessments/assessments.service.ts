...
export type AssessmentSkill = 'speaking' | 'listening' | 'reading' | 'writing' | 'grammar' | 'vocabulary';
export type AssessmentCategory = 'self_assessment' | 'comprehension' | 'production' | 'interaction';
