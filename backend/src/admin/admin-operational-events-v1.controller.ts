...
import { AdminOperationalEventsService, AdminOperationalEventsResult } from './admin-operational-events.service';
...
export class AdminOperationalEventsV1Controller {
  ...
  list(@Query() query: AdminOperationalEventsQueryDto): Promise<AdminOperationalEventsResult> {
