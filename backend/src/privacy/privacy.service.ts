...
export class PrivacyService {
  ...
  async purgeExpiredArchives(limit = 100): Promise<number> {
    ...
    // ⚡ Bolt Optimization: Replaced sequential await loop with a concurrent Promise.allSettled
    // batch to drastically reduce network latency when purging multiple expired archives.
