...
3. If ROADMAP.md exists, update it to reflect the current state and the next priorities. If it does not
   ...
   file.
4. You have no network access from this worktree and cannot reach GitHub. Do not attempt `gh issue create`
   or any other network command - it will fail. Instead, write any new gaps you have identified to
