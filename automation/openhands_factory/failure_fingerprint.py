...
def fingerprint_failure(
    ...
    *,
    ...
    The fingerprint deliberately excludes timestamps, long numeric identifiers, UUIDs,
    commit-like hex strings, and incidental whitespace. Provider and phase remain part
    of the identity when supplied because the same error text can have different retry
    semantics across providers or pipeline phases.
    """
