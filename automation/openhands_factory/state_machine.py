...
class StateMachine:
    """Manage the file-based state handover between CLIs."""
    ...
    def read_context(self) -> FactoryState:
        """Read the current plan and state context for a fresh CLI prompt."""
    ...
    def update_state(self, new_state: str) -> None:
        """Append the latest checkpoint to the state file before a CLI is killed."""
