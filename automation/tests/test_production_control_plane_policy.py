...
def test_production_routes_every_agent_phase_through_openhands() -> None:
    config = json.loads(_read_repository_text("config/factory/agents.production.json"))
...
def test_model_provider_fallback_remains_inside_openhands_boundary() -> None:
    source = _read_repository_text("automation/openhands_factory/conversation_runner.py")
...
def test_active_architecture_matches_production_provider_boundary() -> None:
    architecture = _read_repository_text("docs/factory/ACTIVE_ARCHITECTURE.md")
