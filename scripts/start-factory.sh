...
required_names=(
  FACTORY_REPOSITORY FACTORY_BASE_BRANCH FACTORY_STATE_DIR FACTORY_LOG_DIR
  FACTORY_PROFILE_STORE FACTORY_WORKTREE_DIR FACTORY_PODMAN_PATH FACTORY_TASK_IMAGE
  OPENHANDS_OPENAI_MODEL OPENCODE_GO_API_KEY OPENCODE_GO_BASE_URL OPENCODE_GO_MODEL
  GEMINI_ENABLED GEMINI_FREE_TIER_ONLY FACTORY_MAX_PARALLEL_JOBS
  FACTORY_MAX_TASK_MINUTES FACTORY_MAX_CONVERSATION_TURNS GITHUB_TOKEN GITHUB_REPOSITORY
)
