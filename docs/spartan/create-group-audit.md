...
| Create group action            | `<button hlmBtn>`, disabled until valid, label changes during creation                         | Spartan Helm Button plus Relay async-action recipe                                                  | Retain Spartan Button. Use an approved primary variant, proper busy semantics, and tokenised styling.                                                                             |
