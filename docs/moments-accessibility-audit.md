...
- IME composition must not be treated as a submit keystroke. The existing comment key handler must check the repository composition contract before acting on Enter.
