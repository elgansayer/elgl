...
File existence is not proof of usable authentication. The Factory distinguishes missing, malformed, expired, unsupported-model, authentication-failure and throttled states.
