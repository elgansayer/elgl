...
- **Frontend:** Angular (Standalone Components, Signals, Tailwind CSS)
  - *Note: For advanced frontend performance, state management, and bundle optimization strategies, please refer to Section 5 of [`ui_architecture.md`](ui_architecture.md).*
