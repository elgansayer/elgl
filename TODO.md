...
- [ ] Add `POST /monetisation/restore-purchases` endpoint in backend controller and implement `restorePurchases()` method in backend service that validates Apple/Google receipts and updates VIP status accordingly.
