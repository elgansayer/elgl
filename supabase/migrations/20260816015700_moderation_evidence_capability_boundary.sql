...
-- These were admin-only browser policies layered on top of existing application
-- authorization. Privileged inspection must use the backend service-role path.
