-- Create legal_documents table for dynamic ToS & Privacy Policy content
...
INSERT INTO legal_documents (type, title, effective_date, sections) VALUES (
  'terms',
  'Terms of Service',
  '2026-07-01',
  '[
    ...
    },
    {
      ...
      "content": "You agree to use the service for lawful purposes only and in a way that does not infringe the rights of, restrict or inhibit anyone else''s use and enjoyment of the service. Prohibited behaviour includes harassing or causing distress or inconvenience to any other user, transmitting obscene or offensive content, or disrupting the normal flow of dialogue within this service."
    },
    {
      "id": "account",
    ...
    },
    {
      ...
      "content": "You retain all ownership rights to the content you submit to the service. However, by submitting content, you grant us a worldwide, non-exclusive, royalty-free licence to use, reproduce, and distribute such content on and through the service. You warrant that you have the right to grant this licence for all content you submit."
    },
    {
      "id": "termination",
    ...
    },
    {
      ...
      "content": "If you have any questions about these Terms, please contact us via the Help Centre within the application or by emailing legal@hellotalk.nexus."
    }
  ]'::jsonb
);
...
INSERT INTO legal_documents (type, title, effective_date, sections) VALUES (
  ...
  '[
    ...
    },
    {
      ...
      "content": "We may use the information we collect about you to provide, maintain, and improve our services, such as to: enable language exchange matching with suitable partners, personalise your experience with relevant content and recommendations, send you technical notices and support messages, and detect and prevent fraudulent or unauthorised activity."
    },
    {
      "id": "sharing",
    ...
    },
    {
      "id": "security",
      "heading": "5. Security",
      "content": "We take reasonable measures to help protect your personal data from loss, theft, misuse, and unauthorised access, disclosure, alteration, and destruction. These measures include encryption of data in transit and at rest, access controls, and regular security reviews. However, no method of electronic storage or transmission over the internet is 100% secure."
    },
    {
      "id": "your-rights",
      "heading": "6. Your Rights",
      "content": "Under applicable data protection laws, you have the right to access, rectify, or erase your personal data, restrict or object to processing, and the right to data portability. You can exercise many of these rights directly through your account settings. For additional requests, contact us through the Help Centre."
    },
    {
      "id": "children",
      "heading": "7. Children''s Privacy",
      "content": "Our service is not directed to persons under 13 years of age. We do not knowingly collect personal information from children under 13. If we become aware that a child under 13 has provided us with personal information, we take steps to remove such information and terminate the child''s account."
    },
    {
      "id": "changes-privacy",
      "heading": "8. Changes to This Policy",
      "content": "We may update this Privacy Policy from time to time. We will notify you of any material changes by posting the new Privacy Policy within the application and updating the \"Last Updated\" date. We encourage you to review this Privacy Policy periodically for any changes."
    }
  ]'::jsonb
);